...
| Rol | Descipción | Responsabilidades |
| ------------- | ------------- | ------------- |
| **Functional Analyst** | Analista Funcional | Diseño e implementación de soluciones tecnológicas como redes informáticas, bases de datos y diseño de sitios web.<br>Trabajar con otros miembros de un equipo para determinar la mejor manera de aplicar nuevas tecnologías para cumplir con los objetivos de la organización y mejorar la eficiencia. |
| **Programmer Analyst** | Analista Programador | Utilizar el juicio discrecional dentro de parámetros conocidos para realizar análisis de objetivos comerciales y desarrollar soluciones para problemas de complejidad rutinaria.<br>Realizar análisis de sistemas y desarrollar el código de programación de nivel intermedio a experto. |
| **Database Administrator** | Administrador de Base de Datos | Apoyar las actividades de diseño, creación y prueba de bases de datos.<br>Administrar la disponibilidad y el rendimiento de la base de datos, incluida la gestión de incidentes y problemas.<br>Gestionar los objetos de la base de datos para lograr una utilización óptima. |
| **Architect** | Arquitecto | Proponer una arquitectura de alto nivel y seleccionar tecnologías.<br>Creación de diagramas iniciales, modelos y hojas de ruta arquitectónicas.<br>Seleccionar componentes arquitectónicos o servicios clave para experimentar. |

## Responsibilities
Mi labor principal en Rep-Drill consistió en el desarrollo de un sistema empresarial completo. Si bien participé en el ciclo completo como desarrollador fullstack, mi enfoque principal fue el backend.

Mis responsabilidades incluyeron:
- Diseño y desarrollo de la arquitectura de microservicios: Fui responsable de levantar y mantener los servicios backend encargados de la lógica de negocio. Esto incluyó la gestión de inventario multi-bodega, el procesamiento de ventas y la administración de personas (clientes/proveedores).
- Creación de APIs: Construí las APIs RESTful necesarias para comunicar los microservicios entre sí y para proveer de datos al frontend de React.
- Implementación de análisis predictivo: Desarrollé e integré el módulo de predicción de demanda utilizando Prophet. Esto implicó el procesamiento de datos históricos de ventas de Rep-Drill para generar pronósticos que ayuden a la toma de decisiones de inventario.
- Integración de Inteligencia Artificial: Participé en el desarrollo del backend del chatbot con IA , configurando la lógica de procesamiento de lenguaje natural y conectándolo a las bases de datos de productos y ventas para mejorar la accesibilidad de los usuarios.
- Colaboración Frontend: Brindé soporte al desarrollo frontend asegurando que la integración con el backend fuera eficiente y robusta, trabajando en conjunto para consumir los endpoints creados en el frontend moderno de React.
