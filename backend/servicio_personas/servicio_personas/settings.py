"""
Django settings for servicio_personas project.
...
ROOT_URLCONF = 'servicio_personas.urls'
...
WSGI_APPLICATION = 'servicio_personas.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Rep Drill - API de Personas',
    'DESCRIPTION': 'API RESTful para gestión de personas: clientes, empleados, proveedores y representantes. '
                   'Permite gestionar la información de contacto y relaciones comerciales.',
    'VERSION': '1.0.0',
