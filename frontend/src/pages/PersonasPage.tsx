        ...
        {!isLoading && filteredPersonas.length > 0 && (
          <>
            <div className="mt-4 text-sm text-gray-600">
              Mostrando {((currentPage - 1) * pageSize) + 1} a {Math.min(currentPage * pageSize, filteredPersonas.length)} de {filteredPersonas.length} persona{filteredPersonas.length !== 1 ? 's' : ''}
            </div>
